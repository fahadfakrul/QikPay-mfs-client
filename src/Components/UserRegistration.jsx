    ...
    <div>
      <div className="flex gap-5 justify-end md:justify-between mt-3 mx-3">
        ...
        <div className="flex flex-wrap justify-end gap-2">
         <Link to="/"> <button className="btn  rounded-full bg-gradient-to-r from-[#15FFEE] via-[#2092DE] to-[#2092DE] text-white text-base  md:text-xl  hover:transition hover:scale-105 ">
            Login
          </button></Link>
          <Link to='/agentregistration'> <button className="btn  rounded-full bg-gradient-to-r from-[#15FFEE] via-[#2092DE] to-[#2092DE] text-white text-base  md:text-xl   hover:transition hover:scale-105 ">
            Reg Agent 
          </button></Link>
        </div>
      </div>
